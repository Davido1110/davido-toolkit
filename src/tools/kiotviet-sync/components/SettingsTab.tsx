...
export default function SettingsTab({ onSaved }: { onSaved: () => void }) {
  ...
  return (
    <div className="max-w-lg space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">Kết nối Supabase</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Nhập thông tin Supabase project của bạn. Thông tin này chỉ lưu trên trình duyệt này (localStorage).
        </p>
      </div>
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 pt-5">
        ...
        <ol className="text-sm text-gray-600 dark:text-gray-400 space-y-1 list-decimal list-inside">
          ...
          <li>Set secrets: <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">supabase secrets set KIOTVIET_CLIENT_ID=... KIOTVIET_CLIENT_SECRET=... KIOTVIET_RETAILER=phohangda</code></li>
          <li>Chạy SQL migration trong Supabase SQL Editor (file: <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">supabase/migrations/001_kiotviet_schema.sql</code>)</li>
          <li>Deploy function: <code className="bg-gray-100 dark:bg-gray-800 px-1 rounded">supabase functions deploy kiotviet-sync</code></li>
        </ol>
      </div>
    </div>
  );
